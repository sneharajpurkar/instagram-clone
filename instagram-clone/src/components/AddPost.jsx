...
const AddPost = () => {
  ...
  const [post, setPost] = useState({ caption: "", image: "", username: "", useremail: "", });
        ...
        <div className="post-bot">
          <div>
            <div className="post-bot-top">
              ...
              <div>
                <input onChange={(e) => { fetchData(e); }} name="caption" value={post.caption} type="text" placeholder="Caption" />
                <input onChange={(e) => { fetchData(e); }} name="image" value={post.image} type="text" placeholder="Image Url" />
                <input onChange={(e) => { fetchStory(e); }} name="storyImage" value={story.storyImage} type="text" placeholder="Image" />
              </div>
            </div>
            ...
            <div className="post-button">
              ...
              <button onClick={(e) => { addStory(e) }}>Story</button>
            </div>
          </div>
        </div>
      </div>
